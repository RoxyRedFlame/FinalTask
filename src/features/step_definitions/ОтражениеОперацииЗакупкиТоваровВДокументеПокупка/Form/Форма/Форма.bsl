...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПодготавливаюВспомогательныеДанныеДляПокупки()","ЯПодготавливаюВспомогательныеДанныеДляПокупки","Допустим я подготавливаю вспомогательные данные для покупки");
...
//@ЯПодготавливаюВспомогательныеДанныеДляПокупки()
Процедура ЯПодготавливаюВспомогательныеДанныеДляПокупки() Экспорт
	ЗагрузитьFixtureИзМакета("ТоварДляПокупки");
КонецПроцедуры
