...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПодготавливаюВспомогательныеДанныеДляСебестоимости()","ЯПодготавливаюВспомогательныеДанныеДляСебестоимости","Допустим я подготавливаю вспомогательные данные для себестоимости");
...
//@ЯПодготавливаюВспомогательныеДанныеДляСебестоимости()
Процедура ЯПодготавливаюВспомогательныеДанныеДляСебестоимости() Экспорт
    ЗагрузитьFixtureИзМакета("ТоварДляСебестоимости");
КонецПроцедуры
