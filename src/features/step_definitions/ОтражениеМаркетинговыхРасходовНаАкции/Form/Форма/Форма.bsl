...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПодготавливаюВспомогательныеДанныеДляАкций()","ЯПодготавливаюВспомогательныеДанныеДляАкций","Допустим я подготавливаю вспомогательные данные для акций");
...
//@ЯПодготавливаюВспомогательныеДанныеДляАкций()
Процедура ЯПодготавливаюВспомогательныеДанныеДляАкций() Экспорт
    ЗагрузитьFixtureИзМакета("Акции");
	ЗагрузитьFixtureИзМакета("АкцииСроки");
КонецПроцедуры
