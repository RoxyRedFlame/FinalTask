...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПодготавливаюВспомогательныеДанныеДляЗаполненияАкций()","ЯПодготавливаюВспомогательныеДанныеДляЗаполненияАкций","Допустим я подготавливаю вспомогательные данные для заполнения акций");
...
//@ЯПодготавливаюВспомогательныеДанныеДляЗаполненияАкций()
Процедура ЯПодготавливаюВспомогательныеДанныеДляЗаполненияАкций() Экспорт
