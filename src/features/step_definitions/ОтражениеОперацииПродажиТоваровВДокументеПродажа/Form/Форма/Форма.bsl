...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПодготавливаюВспомогательныеДанныеДляПродажи()","ЯПодготавливаюВспомогательныеДанныеДляПродажи","Допустим я подготавливаю вспомогательные данные для продажи");
...
//@ЯПодготавливаюВспомогательныеДанныеДляПродажи()
Процедура ЯПодготавливаюВспомогательныеДанныеДляПродажи() Экспорт
     ЗагрузитьFixtureИзМакета("ТоварДляПродажи");
КонецПроцедуры
